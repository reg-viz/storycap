    ...
    while (1) {
      switch (_context6.prev = _context6.next) {
        ...
        case 11:
          ...
          browser = _ref3[1];
          _context6.next = 17;
          return Promise.all((0, _utils.createArray)(options.parallel).map(_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
                  ...
                  case 11:
                    ...
                    takeScreenshot = function takeScreenshot(story) {
                      return new Promise(function () {
                        var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(resolve, reject) {
                          var file;
                          return regeneratorRuntime.wrap(function _callee$(_context) {
                            while (1) {
                              switch (_context.prev = _context.next) {
                                ...
                                case 2:
                                  _context.next = 4;
                                  return Promise.all([goto(_constants.PhaseTypes.CAPTURE, {
                                    selectKind: story.kind,
                                    selectStory: story.story
                                  }), new Promise(function (resolveEmitter) {
                                    emitter.once(_constants.EventTypes.COMPONENT_READY, resolveEmitter);
                                  })]);
                  ...
                  switch (_context4.prev = _context4.next) {
                    case 0:
                      ...
                      return Promise.all(chunkedStories.map(function () {
                        var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(arr, i) {
